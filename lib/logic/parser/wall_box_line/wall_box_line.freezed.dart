...
mixin _$MainLine {
 ...
 KiloWattHour get powerLevelWh; DateTime get timeStamp; String get tagID; bool get isStart;
...
@useResult
$Res call({
 DateTime timeStamp,@KiloWattHourConverter()@JsonKey(name: 'powerLevel') KiloWattHour powerLevelWh, String tagID, bool isStart
});
...
as KiloWattHour,null == tagID ? _self.tagID : tagID // ignore: cast_nullable_to_non_nullable
...
mixin _$MVLine {
 ...
 KiloWattHour get powerLevelWh; DateTime get timeStamp;
...
@useResult
$Res call({
 DateTime timeStamp,@KiloWattHourConverter()@JsonKey(name: 'powerLevel') KiloWattHour powerLevelWh
});
