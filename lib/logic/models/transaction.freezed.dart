...
@override
String toString() {
  return 'Transaction(id: $id, tagID: $tagID, wallboxID: $wallboxID, from: $start, to: $stop, usage: $usage)';
}
...
@useResult
$Res call({
 String id, String tagID, String wallboxID, DateTime from, DateTime to,@KiloWattHourConverter()@JsonKey(name: 'usage') KiloWattHour usage
});
...
/// Create a copy of Transaction
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? tagID = null,Object? wallboxID = null,Object? from = null,Object? to = null,Object? usage = null,}) {
...
as String,start: null == from ? _self.start : from // ignore: cast_nullable_to_non_nullable
as DateTime,stop: null == to ? _self.stop : to // ignore: cast_nullable_to_non_nullable
